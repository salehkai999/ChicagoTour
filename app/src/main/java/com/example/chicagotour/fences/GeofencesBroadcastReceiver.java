...
import com.example.chicagotour.BuildConfig;
import com.example.chicagotour.DetailsActivity;
import com.example.chicagotour.R;
...
public class GeofencesBroadcastReceiver extends BroadcastReceiver {
    ...
    private static final String TAG = "GeofencesBroadcastReceiver";
    ...
    public void onReceive(Context context, Intent intent) {
        ...
        for (Geofence g : triggeringGeofences) {
            ...
            FenceData fd = FenceManager.getFence(g.getRequestId());
