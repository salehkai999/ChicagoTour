...
public class FenceManager {
    ...
    public FenceManager(final MapsActivity mapsActivity) {
        ...
        geofencingClient.removeGeofences(getGeofencePendingIntent())
                .addOnSuccessListener(mapsActivity, aVoid -> Log.d(TAG, "onSuccess: "))
        ...
        new Thread(new FencesDownloader(mapsActivity, this)).start();
    }


    public static FenceData getFence(String id) {
    ...
    private PendingIntent getGeofencePendingIntent() {
        ...
        Intent intent = new Intent(mapsActivity, GeofencesBroadcastReceiver.class);
